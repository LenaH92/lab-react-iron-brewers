...
function AddBeerPage() {
  ...
  async function handleSubmit(event) {
    ...
    const newBeerSubmision = {
      name,
      tagline,
      description,
      image_url: imageUrl, // changing to snake_case
      first_brewed: firstBrewed, // changing to snake_case
      brewers_tips: brewersTips, // changing to snake_case
      attenuation_level: Number(attenuationLevel), // convert to a number explicitely
    ...
    try {
      const response = await fetch('https://ih-beers-api2.herokuapp.com/beers/new', {
        ...
        body: JSON.stringify(newBeerSubmision),
      });
